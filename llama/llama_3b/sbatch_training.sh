#!/bin/bash
#SBATCH --job-name=llama3b_training
#SBATCH --output=/mnt/home/oana/projects/nano-grpo-envs/logs/llama3b_training_%j.out
#SBATCH --error=/mnt/home/oana/projects/nano-grpo-envs/logs/llama3b_training_%j.err
...
# Llama-3.2-3B-Instruct Training Jobs
...
echo "=========================================="
echo "Llama-3.2-3B Training Started at $(date)"
echo "=========================================="
...
OUTDIR_BASE="exp_output/llama_3b"
mkdir -p "$OUTDIR_BASE"
...
COMMON_ARGS="--use_vllm --vllm_host ${VLLM_HOST} --vllm_port ${VLLM_PORT} \
    ...
    --eval-size ${EVAL_SIZE} \
    --use_wandb \
    --wandb_project llama-3b-cross-validation"
...
echo ""
echo "=========================================="
echo "All Llama-3.2-3B Training Completed"
